...
function MyClock(canvas,style) {
    ...
    this._DrawClock = function () {
        ...
        _ctx.fillStyle = _style.outerCircle.backgroundColor;
        _ctx.shadowColor = _style.outerCircle.shadowColor;
        //_ctx.shadowBlur = _style.outerCircle.shadowBlur;
        ...
        _ctx.fillStyle = _style.oNumber.color;
        ...
        _ctx.fillStyle = _style.oHourPinter.color;
        ...
        _ctx.fillStyle = _style.oMinutePinter.color;
        _ctx.translate(centerX, centerY);
        ...
        _ctx.fillStyle = _style.oSecondPinter.color;
        _ctx.translate(centerX, centerY);

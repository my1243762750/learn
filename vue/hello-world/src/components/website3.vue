<template>
    <div class="website-container">
        <header class="header">
            ...
            <span class="my-btn-primary" style="margin-left: 10px;" @click="openWebsiteTypeDialog()">添加分类</span>
        </header>
        <!--所有网站-->
        <div class="body">
            <section class="website-list-container" v-for="(item, index) in websiteList" :key="item.typeCode">
                <div class="website-type-header">
                    <h4>{{ item.typeName }}</h4>
                    <div>
                        <span class="my-btn-primary" style="margin-left: 10px;" @click="deleteWebsiteType(index)">删除分类</span>
                        <span class="my-btn-primary" style="margin-left: 10px;" @click="openWebsiteTypeDialog(item, index)">编辑分类</span>
                        <span class="my-btn-primary" style="margin-left: 10px;" @click="openWebsiteDialog(item, 'add')">添加网站</span>
                    </div>
                </div>

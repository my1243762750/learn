<template>
    <div class="website-container">
        <header class="header">
            ...
            <span class="my-btn-primary margin-left-10" @click="openWebsiteTypeDialog()">添加分类</span>
        </header>
        <!--所有网站-->
        <div class="body">
            <section class="website-list-container"
                ...
                <div class="website-type-header">
                    <h4>{{ item.typeName }}</h4>
                    <div>
                        <span class="my-btn-primary margin-left-10" @click="deleteWebsiteType(index)">删除分类</span>
                        <span class="my-btn-primary margin-left-10" @click="openWebsiteTypeDialog(item, index)">编辑分类</span>
                        <span class="my-btn-primary margin-left-10" @click="openWebsiteDialog(item, 'add')">添加网站</span>
                    </div>
                </div>
                <dl class="website-dl"
                    ...
                    <dd v-for="(childItem, childIndex) in item.list"
                        ...
                        <el-popover
                            ...
                            <div style="text-align: center; margin: 0">
                                <el-button type="primary" size="mini" @click="deleteWebsite(item, childIndex)">删除</el-button>
                                <el-button type="primary" size="mini" @click="openWebsiteDialog(item, 'update', childItem, childIndex)">编辑</el-button>
                            </div>
    ...
    export default {
        ...
        methods: {
            ...
            saveWebsiteList(list) {
                ...
                this.request('http://172.16.11.55:9001/saveMenu', list, () => {
            ...
            // 打开添加网站分类模态框
            openWebsiteTypeDialog(item, index) {
                if (item) {
...
.website-container{
    ...
    .body{
        margin-top: 190px + $firstWebsiteItemTypePaddingBottom;
        .website-list-container{
            ...
            &:first-of-type{
                ...
                left: 0;
                right: 0;
                top: 41px + $headerPadding * 2;
                background-color: $fixContentBGC;
                padding: 0 9px;
                padding-bottom: $firstWebsiteItemTypePaddingBottom;
